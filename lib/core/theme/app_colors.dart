...
class AppColors {
  ...
  static const Color textDisabled = Color(0xFFC5CAD0);
  ...
  static const Color lunch = Color(0xFFEF6C00);
  static const Color dinner = Color(0xFF8E44AD);
  static const Color snack = Color(0xFF43A047);
